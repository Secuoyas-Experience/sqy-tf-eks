...
![version](https://img.shields.io/badge/version-v1.22.4-blue)
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cluster_eks"></a> [cluster\_eks](#module\_cluster\_eks) | terraform-aws-modules/eks/aws | 20.24.3 |
